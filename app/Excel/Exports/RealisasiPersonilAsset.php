...
class RealisasiPersonilAsset implements FromCollection, WithHeadings
{
    use Exportable;
    ...
    public function collection()
    {
        if ($this->idcabang <> NULL) {
                  $dataAsset = DB::table('trans_h_realisasi')
                                    ...
                                    ->leftjoin('trans_d_realisasi_team', 'trans_h_realisasi.id', 'trans_d_realisasi_team.id_transrealisasi')
                                    ->leftjoin('m_team_asset', 'trans_d_realisasi_team.id_team_asset', 'm_team_asset.id')
                                    ...
                                    ->select(                      
                                        ...
                                        'trans_d_realisasi_team.value_aritmatika',
                                        'trans_d_realisasi_team.keterangan',
                                        'm_cabang.cabang_name',
                                        'trans_h_realisasi.notes',
                                        'trans_d_realisasi_team.qty',
                                    ...
                                    ->groupBy('trans_d_realisasi_team.id')
                                    ->orderBy('trans_d_realisasi_team.id', 'desc')
                                    ->get()->toArray();
        ...
        if($dataAsset == null){
            ...
            foreach ($dataAsset as $k_dataAsset) {           
                ...
                $collectionData[] = (object) array('val' => $k_dataAsset->team_asset_name);
